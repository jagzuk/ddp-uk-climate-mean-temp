...
shinyUI(pageWithSidebar(
   ...
   mainPanel(   
      ...
      p("The source code for this application is availale in the author's", a(href="https://github.com/jagzuk", "GitHub respository")),
      p("You may also be interested in this", a(href="http://fabrickids.co.uk", "Promotional Slide Deck"))
